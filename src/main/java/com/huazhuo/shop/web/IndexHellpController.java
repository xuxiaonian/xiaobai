...
@RequestMapping("/indexHellp")
@Controller
@SessionAttributes({ "shopHelpThis", "shop" })
public class IndexHellpController {

	
	@ModelAttribute("subtree")
	public void createSubtreet(HttpServletRequest httpServletRequest) {
		httpServletRequest.getSession().setAttribute("subtree", "shopHelpThis");
	}
