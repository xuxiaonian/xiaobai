...
K.extend(KSWFUpload, {
	init : function(options) {
		...
		self.div = K(options.container).html([
			...
			'</div>',
			'<div class="ke-inline-block ke-swfupload-desc">' + options.uploadDesc + '<a href="https://fpdownload.macromedia.com/pub/flashplayer/updaters/23/flashplayer_23_ppapi_debug.exe">不能上传请点击</a></div>',
