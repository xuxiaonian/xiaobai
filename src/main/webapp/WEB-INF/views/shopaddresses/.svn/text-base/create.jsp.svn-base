...
<div class="j-content">
	...
	<div class="col-xs-my-40 j-Commodity-up">
		<!--form 注册表单-->
		<form action="<%=path%>/shopaddresses" method="post" role="form" id="form">
			...
			<div>
				<div class="col-xs-12 j-register-top">
					...
					<div class="col-xs-8 form-group">
						<input type="text" name="contact" datatype="*" value="${shopAddress.contact }" class="col-xs-my-40 form-control" placeholder="请输入公司名称">
					</div>
					<div class="col-xs-2">
					</div>
				</div>
				...
				<div class="col-xs-12 j-register-top" data-toggle="distpicker">
					...
					<div class="col-xs-2 form-group">
						<select name="provinces" class="col-xs-my-48 form-control" id="province7">
						</select>
					</div>
					<div class="col-xs-2 form-group">
						<select name="cities" class="col-xs-my-48 form-control" id="city7"></select>
					</div>
					<div class="col-xs-2 form-group">
						<select name="areas" datatype="*" class="col-xs-my-48 form-control" id="district1"></select>
					</div>
					<div class="col-xs-2">
					</div>
				</div>
				...
				<div class="col-xs-12 j-register-top">
					...
					<div class="col-xs-8 form-group">
						<textarea class="col-xs-my-43 form-control" datatype="*" name="address" rows="3" placeholder="不需要填写省/市/县">${shopAddress.address }</textarea>
					</div>
				...
				<div class="col-xs-12 j-register-top">
					...
					<div class="col-xs-8 form-group">
						<input type="text" name="zipcood" datatype="*" value="${shopAddress.zipcood }" class="col-xs-my-43 form-control" placeholder="请输入邮政编码">
					</div>
					<div class="col-xs-2"></div>
				</div>
				<!--邮政编码-->
				<div class="col-xs-12 j-register-top">
					...
					<div class="col-xs-8 form-group">
						<input type="text" name="phoneNumber" datatype="m" value="${shopAddress.phoneNumber }" class="col-xs-my-43 form-control" placeholder="请输入手机号码">
					</div>
					<div class="col-xs-2"></div>
				</div>
				<!--手机号码-->
				...
				<div class="col-xs-12">
					...
					<div class="col-xs-3 j-register-top">
						<button  onclick="address(true)"  class="button button-action button-rounded" id="Preservation">保存并且返回</button>
					</div>
					<div class="col-xs-3 j-register-top">
...
$("#form").Validform({
	...
	function address(str){
		...
		$("#form").append('<input type="hidden" name="address" value="'+str+'"/>');
		$("#form").submit();
	}
</script>
