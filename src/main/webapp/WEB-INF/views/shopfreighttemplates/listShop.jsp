...
<div class="j-content">
	...
	<div class="col-xs-my-40 j-Commodity-up">
		<a class="button " href="/shop/shopfreighttemplates">单品运费模板</a> <a class="button button-action" href="">店铺运费模板</a>
		...
		<div class="j-body-up">
			...
			<div class="col-xs-my-48 j-freight">
				...
				<div class="col-xs-4">
					<a href="<%=path %>/shopfreighttemplates/12?shops" class="button button-action button-rounded">新增运费模版</a>
				</div>
				<div class="col-xs-4">&nbsp;</div>
			</div>
			<!--/新增运费模版-->
				...
				<c:if test="${ shopfreighttemplate.templateType ==0 }">
				 ...
				 <div class="col-xs-my-48">
					...
					<div class="col-xs-my-46 j-table-tit3">
						<div class="col-xs-my-20 j-table-size">&nbsp;${(status.index+1)}.${shopfreighttemplate.name }（包邮）</div>
