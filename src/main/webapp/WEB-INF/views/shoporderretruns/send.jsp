...
<div class="col-xs-my-46">
	<form method="post" id="formId">
		<input type="hidden" name="method" value="disagreeReturnOrderSend" />
		...
		<div class="j-body-up j-Inform-height">
			...
			<div class="col-xs-my-48 j-remind">
				...
				<div class="col-xs-10">
					<select name="logisticsCompanyId" id="select2" class="col-xs-12 form-control" data-live-search="true">
						<c:forEach items="${logisticsCompanies }" var="logisticsCompany">
							<option value="${logisticsCompany.id }">${logisticsCompany.logisticsName }</option>
						</c:forEach>
					</select>
				</div>
				<div class="col-xs-1">&nbsp;</div>
