...
<!-- 		*  参与活动数量 -->
	...
	<div class="form-group">
		...
		<div class="col-xs-5">
			<input  readOnly="true" class="form-control datetimepicker" id="endtime"  size="16" type="text" value="<fmt:formatDate value="${endTime }" pattern="yyyy-MM-dd hh:mm:ss"/>">
    	</div>
    </div>
<!--      <div class="form-group"> -->
...
// 		    	alert($("#rewardRatio").val().length)
		    ...
		    var price = $("input[name='productsSpecId']:checked").parents('tr').eq(0).find('td:last').text();
			 ...
			 $("#myForm").append('  <input type="hidden" id="orgPrice" name="orgPrice" value="'+orgPrice+'" />');
