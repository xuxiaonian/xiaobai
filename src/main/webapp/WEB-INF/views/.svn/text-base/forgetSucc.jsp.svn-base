...
<div class="j-successful col-xs-my-48">
	...
	<div class="col-xs-my-11 j-successful-a">
		<a href="#" name="login">登录|</a> <a href="#" name="reister">注册</a>
	</div>
</div>
<!--content部分-->
<div class="j-content">
	...
	<div class="col-xs-my-40 j-bodySUC">
		...
		<div class="col-xs-my-48 j-icon">
			...
			<div class="col-xs-my-19 j-size">修改成功<a href="<%= path%>/login">立即登录</a></div>
			<div class="col-xs-my-8">&nbsp;</div>
		</div>
		<div class="col-xs-my-48 j-pad">
			<div class="col-xs-my-20">&nbsp;</div>
			<div class="col-xs-my-18 j-font1"></div>
			<div class="col-xs-my-10">&nbsp;</div>
		</div>
		<!--/注册成功-->
	</div>
	<!--/content 部分-->
